...
- [x] restore state on load and reconnect map overlays to stored cells
- [x] integrate browser geolocation to move player position in real time
- [x] run multi-session tests combining real and simulated movement
-
